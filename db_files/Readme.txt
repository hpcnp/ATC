Information on the Saguaro Astronomy Club Database version 7.2

	dated Aug. 5, 2000   

	by Steve Coe,  SAC Vice President
	email:  scoeandlross@excite.com


This club project started many years ago, when we wanted a listing
...
SACDOC.TXT is the documentation for the SAC database, there
...
SAC72.TXT is version 7.2 of the Saguaro Astronomy Club
...
to each other at the end of each record, so that they can be easily 
included or left out of a printed observing list.

Bill Anderson and A.J. Crayon made the three changes above and 
their effort will make the data much easier for modern database 
managers to use.  Also, the BCHM field will allow users to
quickly create a Messier or Herschel 400 observing list.  Bill
and AJ's expertise in searching, sorting, checking and correcting
the data as a large text file makes it much easier to distribute
it in that universal form.  Thank you very much.

Much time and effort was spent to update the data with information
available on the WWW.NGCIC.ORG Web site.  Thanks to Bob Erdmann
...
to the beginnings of this database.  Brian Skiff of Lowell Obs. has 
also been a constant help with a variety of information about 
these deep sky objects.  Stephen Michael Schimpf spent much time
with the NOTES field, finding errors and trying to make the 
